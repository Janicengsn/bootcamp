...
// ! 2. Cannot inherit constructor from Parent class, but we can call Parent' constructor by "super"
// ! 3. Inherit instance method from Parent class. (Not exactly,)
public class Cat extends Animal {
  // private int age;
  private String name;

  public Cat(String name, int age) {
    super(age); //  refer to "Animal.java"'s constructor
    this.name = name;
  }

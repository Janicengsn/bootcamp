...
public abstract class Animal { // Parent Class: concrete class or abstract class
  ...
  public static void main(String[] args) {
    ...
    // Animal animal2 = new Animal(13);
      ...
      // ! Polymorphism (Runtime/Dynamic Polyorphism)
      // ! 1. instance method call is determined by object refernce type (compile-time)
      // ! 2. the implementation of method is determined by actual object itsself (runtime)
      ...
      } else if (cat2 instanceof Dog2) {
        Dog2 animal3 = (Dog2) cat2;

...
public class DemoBigDecimal {
  public static void main(String[] args) {
    ...
    BigDecimal bd3 = bd1.add(bd2); // add = Math +
    System.out.println(bd3);

    float f1 = bd3.floatValue();
    System.err.println(f1); // 0.3

public class DemoString {
  public static void main(String[] args) {
    ...
    System.out.println(s4.lastIndexOf('l')); // 3, last charactr of l
    ...
    System.out.println(s8.substring(4, 7)); // "o w" // 用substring要俾兩個數字, 4(第一個)=beginIndex' 7(後面個個)=endIndex (setting上自動-1)
    ...
    // Function 12: valueOf() -> Conversion 揸住String去convert
    int x = 3;
    String ss = String.valueOf(x);
    System.out.println(ss); // ss convert to 3
    String ss2 = String.valueOf(3.3);
    System.out.println(ss2); // ss convert to 3.3
